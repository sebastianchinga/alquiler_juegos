...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($alertas)) {
        ...
        if ($resultado) {
            header('Location: /admin/index.php?alerta=1');
        }
    }
}
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    ?>
                    <form action="/admin/juego/crear.php" method="POST" class="my-3" enctype="multipart/form-data">
                        <?php include __DIR__ . '/formulario.php' ?>
                        <div class="form-group">
                            <input type="submit" value="Agregar videojuego" class="btn btn-primary btn-block">
                        </div>
                    </form>
